...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 disabled:pointer-events-none disabled:bg-disabled [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 !leading-none w-fit",
  {
    variants: {
      variant: {
        default: "bg-main-600 text-black-900 hover:bg-main-650 transition-colors duration-400",
        secondary: "bg-secondary-500 hover:bg-secondary-525 text-white",
        ...
        cancel:
          "border border-neutral-300 bg-neutral-100 hover:bg-neutral-100 text-black-700",
        link: "text-zinc-900 underline-offset-4 hover:underline",
        black: "bg-black text-white py-4 px-10",
      },
      size: {
        default: "px-6 py-4",
        sm: "px-6 py-3.5 rounded-full text-sm",
        lg: "px-6 py-3.5 md:px-10 md:py-4",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
