        ...
        <div className="flex flex-col items-center justify-center pt-14 md:pt-20 max-w-7xl mx-auto">
          <div className="text-white text-3xl sm:text-5xl md:text-6xl font-bold text-center relative mb-12">
            <SplitText
              ...
              className="w-[95%] lg:w-full max-w-3xl mx-auto text-[33px] md:text-5xl lg:text-6xl"
            />
            <motion.button
              animate={{ rotate: 360 }}
              transition={{ duration: 1 }}
              className="bg-main-700 text-black font-extrabold py-1 px-8 rounded-full mt-2 mb-6 absolute  text-xs md:text-sm lg:text-xl border-4 border-secondary-525 right-28 sm:right-28 md:right-44 lg:right-36 top-[60px] sm:top-6 md:top-8 lg:top-10"
            >
              <div>GRAB IT</div>
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <CalendarPicker
                        ...
                        className={cn(
                          errors.startDate && "border border-red-500 rounded-xl"
                        )}
                      />
                    )}
                  />
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <CalendarPicker
                        ...
                        onChange={field.onChange}
                        className={cn(
                          errors.endDate && "border border-red-500 rounded-xl"
                        )}
                      />
                    )}
                  />
          ...
          <img
            ...
            className="min-h-[220px] object-cover md:object-contain"
          />
        </div>
      </section>
    </section>
