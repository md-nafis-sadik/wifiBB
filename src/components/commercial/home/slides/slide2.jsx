              ...
              <div className="flex flex-col h-full items-center justify-between pt-20  max-w-7xl mx-auto">
                ...
                <SplitText text="Japan’s WiFi Flash Sale!" className="w-[95%] lg:w-full max-w-2xl mx-auto text-4xl sm:text-5xl md:text-6xl lg:text-7xl" />
                  <motion.button
                    ...
                    className="bg-main-650 text-black font-extrabold py-1 px-8 rounded-full mt-2 mb-6 absolute  text-xs md:text-sm lg:text-xl border-4 border-secondary-525 right-24 sm:right-28 md:right-40 lg:right-32 top-16 sm:top-6 md:top-8 lg:top-10"
                  >
                    <div>GRAB IT</div>
