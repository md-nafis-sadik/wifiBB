    ...
    return (
        <div>
            ...
            <section className="w-full relative bg-gradient-to-b from-secondary-525 to-secondary-600">
                ...
                <div className="flex flex-col items-center justify-center pt-12 md:pt-20 max-w-7xl mx-auto">
                    <div className="text-white text-3xl sm:text-5xl md:text-6xl font-bold text-center relative mb-10">
                    ...
                    <motion.form
                        ...
                        className="bg-white rounded-3xl shadow-lg w-[95%] max-w-2xl lg:max-w-3xl mt-2 p-3 md:p-5"
                    >
