    ...
    return (
        <section className="w-full relative bg-main-600 h-full"  style={{ backgroundImage: `url(${images.buildingMask})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
              <div className="flex flex-col  h-full  lg:flex-row items-center lg:items-start justify-between pt-20 px-4  max-w-7xl mx-auto">
                ...
                <SplitText text="Stay Connected While Traveling" className="w-[95%]  lg:w-full max-w-3xl mx-auto text-[33px] sm:text-5xl md:text-6xl lg:text-7xl text-[#764111]" />
                ...
                <div className="flex justify-end items-end h-full" ><img src={images.heroImage2} className="min-h-[300px] h-28 lg:h-auto object-cover md:object-contain" /></div>
              </div>
